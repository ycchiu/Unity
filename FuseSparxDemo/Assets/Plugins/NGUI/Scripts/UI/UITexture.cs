...
{
	// EBG START - make variables protected instead of private
	...
	[HideInInspector][SerializeField] protected Shader mShader;

	protected int mPMA = -1;
	// EBG END

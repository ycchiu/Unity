...
public class UIInput : MonoBehaviour
{
	...
	// EBG START - keyboard display callback
	/// <summary>
	/// Delegate for keyboard display
	/// </summary>
	public delegate void OnKeyboardDisplay(bool shown);
	
	/// <summary>
	/// Custom keyboard display callback.
	/// </summary>
	public OnKeyboardDisplay onKeyboardDisplay;
	// EBG END
	...
	protected void OnSelectEvent ()
	{
		...
		if (label != null && NGUITools.GetActive(this))
		{
			...
			)
			{
				...
				// EBG START
				if (onKeyboardDisplay != null) onKeyboardDisplay(true);
				// EBG END
			}
			else
#endif
	...
	protected void OnDeselectEvent ()
	{
		...
		if (label != null && NGUITools.GetActive(this))
		{
			...
			if (mKeyboard != null)
			{
				...
				// EBG START
				if (onKeyboardDisplay != null) onKeyboardDisplay(false);
				// EBG END
			}
#endif

...
public class UIFont : MonoBehaviour
{
	...
	// EBG START - uppercase-only font support
	[HideInInspector][SerializeField] bool mOnlyUppercase = false;
	// EBG END
	...
	// EBG START - uppercase-only font support
	/// <summary>
	/// Does this font support only uppercase characters?
	/// </summary>
	public bool onlyUppercase { get { return mOnlyUppercase; } set { mOnlyUppercase = value; } }
	// EBG END
	...
	public void MarkAsChanged ()
	{
		...
		for (int i = 0, imax = labels.Length; i < imax; ++i)
		{
			...
			{
				// EBG START - refresh selector bitmap font
//				UIFont fnt = lbl.bitmapFont;
//				lbl.bitmapFont = null;
//				lbl.bitmapFont = fnt;
				if (lbl.selectorFont != null)
				{
					FontSelector fnt = lbl.selectorFont;
					lbl.selectorFont = null;
					lbl.selectorFont = fnt;
				}
				else
				{
					UIFont fnt = lbl.bitmapFont;

...
public class UIGeometry
{
	...
	// EBG START - UVs2
	/// <summary>
	/// Optional second set of UVs for masking, etc.
	/// </summary>
	...
	// EBG START - uvs2
	public void WriteToBuffers (BetterList<Vector3> v, BetterList<Vector2> u, BetterList<Vector2> u2, BetterList<Color32> c, BetterList<Vector3> n, BetterList<Vector4> t)
	// EBG END
	{

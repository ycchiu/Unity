...
static public class NGUITools
{
	...
	// EBG START - This was removed for some reason, but it's useful!
	/// <summary>
	/// Find all loaded components regardless of active state.
	/// </summary>
	...
	/// </summary>
	/// EBG START - Cache results in dictionary
	private static System.Collections.Generic.Dictionary<int, Camera> camerasByLayer = new System.Collections.Generic.Dictionary<int, Camera>();
	static public Camera FindCameraForLayer (int layer)
	{
		if (camerasByLayer.ContainsKey(layer))
		{
			Camera layerCam = camerasByLayer[layer];
			if (layerCam == null)
			{
	...
	/// EBG END - Cache results in dictionary
	...
	static public GameObject AddChild (GameObject parent, GameObject prefab)
	{
		...
		if (go != null && parent != null)
		{
			...
			t.localRotation = Quaternion.identity;
			t.localScale = Vector3.one;
			// EBG START - recursively set layer

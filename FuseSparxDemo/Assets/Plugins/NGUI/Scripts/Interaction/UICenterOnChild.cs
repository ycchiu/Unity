...
public class UICenterOnChild : MonoBehaviour
{
	...
	// EBG START - make OnEnable virtual
//	void OnEnable () { }
	protected virtual void OnEnable () { Recenter(); }
	// EBG END
	...
	public void Recenter ()
	{
		...
		// EBG START - Allow customization of what we're iterating through here:
		List<Transform> childTransforms = GetCenterOnItems();
	...
	// EBG START
	protected virtual List<Transform> GetCenterOnItems()
	{

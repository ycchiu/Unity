...
public class FBSettings : ScriptableObject
{
	...
	public static FBSettings Instance		// moko-ebg: publicilize instance interface for good cause
	{
		get
		{
			if (instance == null)
	...
	[SerializeField]
	private string[] appIds = new[] { "0", "352930141483598", "145130572313729", "180296902011536" };	// moko: hard coding "ff-six-the-game" id due to FB serialization issue
	[SerializeField]
	private string[] appLabels = new[] { "ebg-placeholder", "ff-six-the-game", "ffsixdev", "spxalocal" };
	[SerializeField]

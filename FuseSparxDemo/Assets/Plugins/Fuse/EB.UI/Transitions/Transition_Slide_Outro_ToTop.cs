...
public class Transition_Slide_Outro_ToTop : EBUI_Transition {
	...
	{						
		...
		_tweener = TweenPosition.Begin (gameObject, info.duration, new Vector3(0.0F,Screen.height*2, originalZ));

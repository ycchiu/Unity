...
public class UIWidgetInspector : UIRectEditor
{
	...
	protected override void DrawCustomProperties ()
	{
		...
		{
			GUI.color = Color.red;
			GUILayout.Label("Geometry Updated: " + mWidget.geometryUpdates + " times");
			GUI.color = Color.white;
		}
		// EBG END
		...
		if (NGUIEditorTools.DrawHeader("Widget"))
		{
			...
			// EBG START - mIsRendering toggle
			NGUIEditorTools.DrawProperty("Is Rendering", serializedObject, "mIsRendering", GUILayout.MinWidth(20f));
			// EBG END
	...
	// EBG START - make public
	public void DrawDepth (bool isPrefab)
	// EBG END - make public
	{
		if (isPrefab) return;

...
public class GCM {
	...
	public static void ShowToast (string message) {
		if (Application.platform == RuntimePlatform.Android) {
			using (AndroidJavaClass cls = new AndroidJavaClass ("com.otherlevels.androidportal.Util")) {;
	...
	/// <summary>
	/// Setup the Launch Activity.
	/// </summary>
	/// <param name='launchActivity'>
	/// LaunchActivity.
	/// </param>
	public static void SetupLaunchActivity (string activityName) {
		if (Application.platform == RuntimePlatform.Android) {
			...
			using (AndroidJavaClass cls = new AndroidJavaClass (CLASS_NAME)) {
				cls.CallStatic ("setupLaunchActivity", activityName, context);
			}
		}
	}
	...
	/// On message.
	/// </param>
	public static void SetMessageCallback (System.Action<string> onMessage) {

...
public class LWFObject : MonoBehaviour
{
	...
	// EBG START
	protected bool useNGUIRenderer;
	// EBG END
	...
	public virtual void OnDestroy()
	{
		...
		for (int i = 0; i < lwfDestroyCallbacks.Count; ++i)
		{
			lwfDestroyCallbacks[i](this);
		}
		// EBG END
	...
	// EBG START
	public void UseNGUIRenderer()
	{
		useNGUIRenderer = true;
		useCombinedMeshRenderer = false;
	}
	// EBG END
	...
	public virtual bool Load(string path,
		...
		TextureUnloader textureUnloader = null,
 		// EBG START
		LWF.IFontAdapter fontAdapter = null,
 		LWF.ITextureAdapter textureAdapter = null
	    // EBG END
#if LWF_USE_LUA
		...
		)
	{
		...
		// EBG START
		} else if (useNGUIRenderer) {
			factory = new LWF.NGUIRenderer.Factory(
				data, gameObject, zOffset, zRate, renderQueueOffset, camera,
				texturePrefix, fontPrefix, textureLoader, textureUnloader, fontAdapter, textureAdapter);
		// EBG END
	...
	public virtual void OnLoad()
	{
		...
		for (int i = 0; i < lwfLoadCallbacks.Count; ++i)
		{
			lwfLoadCallbacks[i](this);
		}
		// EBG END
	...
	public virtual void Update()
	{
		...
		// EBG START - Input detection usurped by NGUI
//		if (lwf.interactive) {
...
//		}
	...
	// EBG START
	// Using NGUI OnPress mechanism
	public virtual void OnPressed(bool isPressed)
	{
		if (lwf == null)
			return;

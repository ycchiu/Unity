...
public class Object
{
	...
	// EBG START
	protected int m_layerDepth;
	protected System.Object m_linkedObject;	
	protected bool m_invokeUpdateDelegate;
	public System.Action onDestroy;
	public System.Action<Object> onUpdateDelegate;
	// EBG END
	...
	// EBG START
	public int layerDepth { get { return m_layerDepth; } }
	public System.Object linkedObject { get { return m_linkedObject; } set { m_linkedObject = value; } }
	public virtual Object [] children { get { return null; } }
	...
	{
		if (m_invokeUpdateDelegate)
		{
			m_invokeUpdateDelegate = false;
	...
	public virtual int RefreshDepth(int depth = 0)
	{
		// only elements with a renderable component should have a layer depth, and update
		if (m_renderer != null)
		{
			m_layerDepth = depth++;
		}
	...
	// EBG START - why do tertiary boolean when return type is bool?  silliness.
	public bool IsButton() {return m_type == Type.BUTTON; }// ? true : false;}
	public bool IsMovie() {return (m_type == Type.MOVIE || m_type == Type.ATTACHEDMOVIE); }// ? true : false;}
	public bool IsParticle() {return m_type == Type.PARTICLE; }// ? true : false;}
	public bool IsProgramObject() {return m_type == Type.PROGRAMOBJECT; }// ? true : false;}
